...
class DetailViewModel(private val storage : Storage, private val application: Application) : ViewModel() {
    ...
    fun getTouristById(id: String) = storage.getDetailTourism(id)
